...
top_5_data = Top_Country_Monthly_Revenue[Top_Country_Monthly_Revenue['Country'].isin(top_5_countries)].copy()
top_5_data['Year_Month'] =top_5_data['Year'].astype(str) + '-' + top_5_data['Month'].astype(str).str.zfill(2)
top_5_data = top_5_data.sort_values('Year_Month')
sns.lineplot(data=top_5_data, x='Year_Month', y='Monthly_Revenue', marker = 'o')
