...
def plot_claims_vs_revenue(monthly_claims_revenue_by_store):
    # Aggregate by store
...
plot_claims_vs_revenue(monthly_claims_revenue_by_store)

# %%
# Line Graph: Top Country by Monthly Revenue
limit = 5
sort_order = 'DESC'
...
# %%
# Line Graph: Top 5 Stores by Monthly Revenue
limit = 5
sort_order ='DESC'
